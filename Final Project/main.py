...
X_train, X_validate, y_train, y_validate = train_test_split(X_train, y_train, test_size = 10, random_state = 0, stratify = y_train)

neural_net_model = MLPClassifier(hidden_layer_sizes=(12), random_state = 42, tol = 0.0025, max_iter = 400)
...
# For comparison, count correct _validation_ set predictions
...
overall_validate_accuracy = correct_counts_validate / total_counts_validate*100
print(f"Overall Validation Accuracy: {overall_validate_accuracy:3.1f}%")
...
#'''
print()
print("Row 6, Column 5 is the most commonly misidentified. \n")
print("4 x 3, 2 x 6, and 7 x 6 are all the 2nd most commonly misidentified.")
